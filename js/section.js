...
const infoContent = {
    ...
    'warranty': {
        ...
        text: `
            <p>Мы предлагаем гарантию на все наши сертификаты.:</p>
            <ul>
                <li>Обычный Сертификат гарантия 3 месяца.</li>
                <li>Моментальный Сертификат гарантия 6 месяцев.</li>
                <li>Супер-Моментальный Сертификат гарантия 6 месяцев.</li>
                <li>Парный Сертификат гарантия 3 месяца.</li>
                <li>Обычный iPad гарантия 6 месяцев.</li>
            <p>При случайном выборе и оплате сертификата возврат средств невозможен.:</p>
