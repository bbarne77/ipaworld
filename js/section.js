...
const infoContent = {
    ...
    // 🔥 НОВАЯ ИНФОРМАЦИЯ ДЛЯ УСЛОВИЙ ГАРАНТИИ
    'warranty': {
        title: '📝 Условия Гарантии',
        text: `
            <p>Мы предлагаем гарантию на все наши сертификаты. Если сертификат перестает работать по нашей вине, мы бесплатно выдадим новый. Гарантия не распространяется на следующие случаи:</p>
            <ul>
                <li>❌ Вы деактивировали сертификат в боте вручную.</li>
                <li>❌ Вы проигнорировали наше сообщение о необходимости переподписать сертификат.</li>
                <li>❌ Вы отвязали сертификат от UDID устройства.</li>
                <li>❌ Вы купили сертификат не у нас.</li>
                <li>❌ Вы установили другой сертификат поверх нашего.</li>
            </ul>
        `
    }
};
