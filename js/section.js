...
const infoContent = {
    ...
    'get-certificate': {
        ...
        text: `
            ...
            <ul>
                <li>Отправляете <strong>/start</strong> боту.</li>
                ...
                <li>Бот пришлет вам два файла вашего сертификата - <strong>P12</strong> и <strong>Mobileprovision</strong>, а также ссылки для быстрой установки вашего сертификата.</li>
            </ul>

            <br><h3>Пункт 2: Как сохранить сертификат на устройство.</h3>
            <p>Когда бот прислал вам два файла сертификата, то вам нужно нажать на один из них.</p>
            ...
            <p>В открывшемся окне нажмите на кнопку, расположенную сверху.</p>
            ...
            <p>У вас снова откроется окно, в нем выберите кнопку "Сохранить в файлы".</p>
            <p>Выберите место для сохранения сертификата.</p>
            <p>Нажмите на кнопку "Сохранить" слева вверху.</p>
            <p>Повторите для второго файла сертификата.</p>
        `
    },
    'scarlet': {
