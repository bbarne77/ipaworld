...
const infoContent = {
    ...
    'warranty': {
        ...
        title: '⚠️ Гарантия',
        text: `
            <p>Мы предоставляем гарантию на все приобретенные у нас сертификаты. Гарантийные сроки различаются в зависимости от типа сертификата:</p>
            <ul>
                <li><strong>Обычный Сертификат:</strong> 1 месяц</li>
                <li><strong>Моментальный Сертификат:</strong> 3 месяца</li>
                <li><strong>Супер-Моментальный Сертификат:</strong> 3 месяца</li>
                <li><strong>Парный Сертификат:</strong> 1 месяц</li>
                <li><strong>Обычный iPad:</strong> 1 месяц</li>
            </ul>
            <p><strong>Внимание:</strong> При ошибочном выборе и оплате сертификата возврат средств невозможен. Пожалуйста, будьте внимательны при оформлении заказа.</p>
            <p>
                Наш магазин не предоставляет никаких гарантий на сертификаты, при покупке вы должны понимать то,
                что Apple в любой момент могут досрочно аннулировать ваш сертификат и наш магазин никак не может на это повлиять!
                Возврат или частичное возмещение каких-либо сборов, уплаченных по настоящему Соглашению, или любых других сборов
                не будет производиться ни по какой причине.
            </p>
            <p>
