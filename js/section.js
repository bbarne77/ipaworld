...
const infoContent = {
    ...
    'warranty': {
        ...
        text: `
            <p>
                Наш магазин предоставляет гарантию на все сертификаты:
    
                <p>Обычный сертификат IPHONE - 3 месяца</p>
                <p>Моментальный сертификат IPHONE - 3 месяца</p>
                <p>Супермоментальный сертификат IPHONE - 6 месяцев</p>
                <p>Парный сертификат - 3 месяца</p>
                <p>Сертификат IPAD - 3 месяца</p>
                <n>Данные условия гарантии вступают в силу с 16.09.2025г</n>
                
                <n>Возврат или частичное возмещение каких-либо сборов, уплаченных по настоящему Соглашению, или любых других сборов
                не будет производиться ни по какой причине.Читайте наше пользовательское соглашение!</n>
            </p>
            <p>
